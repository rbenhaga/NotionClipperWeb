...
export default function PricingPage() {
  ...
  const annualPrice = 28.68; // €2.39/month billed annually
      ...
      <section className="relative pt-32 pb-20 px-4">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="inline-flex items-center bg-white/80 backdrop-blur-sm rounded-full p-1 shadow-md border border-gray-200">
              ...
              >
                ...
                <span className="ml-2 text-xs bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full">
                  {t('billing.save')} {annualSavings.toFixed(2)}€
                </span>
              </button>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300 opacity-75">
              {/* Coming Soon Badge */}
              <div className="absolute -top-4 left-1/2 -translate-x-1/2">
          ...
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/80 backdrop-blur-sm rounded-full shadow-md border border-gray-200">
              ...
              <span className="text-gray-700 font-medium">
                {t('trust.trial')} • {t('trust.cancel')} • {t('trust.noQuestions')}
              </span>
            </div>
          </div>
